...
class CSVPlotter:
    ...
    def plot_data(self, x_column, y_columns, plot_type='line', title='', x_label='', y_label='', font_size=24,max_frame=742,truncate_frame=180):
        ...
        plt.axhline(y=55.020, color='r', linestyle='--', label='y = 0.5')
        plt.axhline(y=25.013, color='b', linestyle='--', label='y = 0.5')
...
converted_string = double_backslashes(
    ...
    r"C:\Users\nares\Desktop\allout\20240118\20240118_1044_42top.csv"
)
