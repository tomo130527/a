...
class CSVPlotter:
    ...
    def plot_data(self, x_column, y_columns, plot_type='line', title='', x_label='', y_label='', font_size=24,max_frame=99999,truncate_frame=0):
        ...
        axs[1].set_ylabel('Sum of BD', fontsize=font_size)
        axs[1].axhline(y=28.65, color='r', linestyle='--', label='Upper Th = 28.65')
        axs[1].axhline(y=10.65, color='b', linestyle='--', label='Lower Th = 10.65')
        axs[1].legend()
...
csv_plotter.plot_data(x_column='SN', y_columns=['SD','Contrast'], plot_type='line', title='CSV Data Plot', x_label='Time (s)', y_label='Y-axis', font_size=24)
